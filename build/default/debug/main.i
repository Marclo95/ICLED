...
void LCD_UpdateMenu(void) {
    ...
    switch (etat_courant) {
        case MENU_PRINCIPAL:
            ...
            LCD_SetCursor(2,0); LCD_String("3.? 2.Animation");
            break;
...
void send_bit(uint8_t bit) {
    if (bit) {
        LATBbits.LATB5 = 1;
        _delay((unsigned long)((0.7)*(64000000U/4000000.0)));
        LATBbits.LATB5 = 0;
        _delay((unsigned long)((0.6)*(64000000U/4000000.0)));
    } else {
        LATBbits.LATB5 = 1;
        _delay((unsigned long)((0.35)*(64000000U/4000000.0)));
        LATBbits.LATB5 = 0;
        _delay((unsigned long)((0.8)*(64000000U/4000000.0)));
    }
}
